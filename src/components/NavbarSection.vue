  ...
  <header class="header">
    <div class="header-content">
      ...
      <div class="auth-buttons">
        <button class="signup-btn" @click="redirectToSignUp">Sign up</button>
...
.signup-btn {
  ...
  justify-content: center;
  border-radius: 5px;
  border: 1px solid rgba(27, 94, 31, 1);
  background-color: var(--warna-text, #fff);
  color: #1b5e1f;
  padding: 10px 20px;
}
