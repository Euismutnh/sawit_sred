        ...
        <header class="header">
          <div class="overlap-2">
            <DivWrapper
              ...
              frameWrapperFrameClassNameOverride="frame-5"
              frameWrapperFrameDivClassName="design-component-instance-node"
              frameWrapperFramePropertyDefaultClassName="frame-7"
